...
<head>
    ...
    <script src="http://127.0.0.1/frms-site/resources/sockjs-0.3.4.js"></script>
    <script src="http://127.0.0.1/frms-site/resources/stomp.js"></script>
    <script type="text/javascript">
        ...
        function connect() {
            var socket = new SockJS('/frms-site/add');

...
<head>
    ...
    <link href="${path}/res/css/bootstrap.min.css?v=3.4.0" rel="stylesheet">
    <link href="${path}/res/font-awesome/css/font-awesome.css?v=4.3.0" rel="stylesheet">

    <!-- Morris -->
    <link href="${path}/res/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="${path}/res/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">

    <link href="${path}/res/css/animate.css" rel="stylesheet">
    <link href="${path}/res/css/style.css?v=2.2.0" rel="stylesheet">
    
     <!-- Mainly scripts -->
    <script src="${path}/res/js/jquery-2.1.1.min.js"></script>
    <script src="${path}/res/js/bootstrap.min.js?v=3.4.0"></script>
    <script src="${path}/res/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${path}/res/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="${path}/res/js/hplus.js?v=2.2.0"></script>
    <script src="${path}/res/js/plugins/pace/pace.min.js"></script>
...
<body>
	<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="${path}/res/img/profile_small.jpg" />
                             </span>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="####" onClick="loadHtml('${path}/jsp/list.jsp');">主页示例一</a>
                            </li>
                            <li><a href="####" onClick="loadHtml('${path}/jsp/input.jsp');">主页示例二</a>
                            </li>
                            <li><a href="####" onClick="loadHtml('${path}/test2.htm');">主页示例三</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div id="nextContainer" style="margin:0;padding:0 15px;">
...
function loadHtml(url, data){
	$("#nextContainer").html("");
	//loading图标
	$("#nextContainer").load(url, data, function() {
	});
}
</script>
</html>
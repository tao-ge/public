...
<script type="text/javascript" src="${path }/js/facility/remoteUnlockApplyAdd.js"></script>
...
<body>
	...
	<div class="formbody">
		<form name="unlockApplyForm" id="unlockApplyForm" action="${path}/saveRemoteUnlockApply.htm">
			<div class="formtitle">
				<span>基本信息</span>
			</div>
			...
			<table class="tableForm">
				<tbody>
					...
					<tr>
						<td>申请时间：</td>
						<td><input id="applyTime" name="applyTime" type="text" placeholder="单位：分钟"/></td>
					</tr>
					<tr>
						<td>备注：</td>

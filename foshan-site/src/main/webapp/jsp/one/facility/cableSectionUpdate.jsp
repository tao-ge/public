				...
				<tbody>
					...
					<tr>
						<td style="text-align: center;" colspan="4">
							<input name="fiberNum" type="hidden" value="${sect.fiberNum}" />
							<input name="devIdA" name="devIdA" type="hidden" value="${sect.devAName}" />
							<input name="devIdZ" name="devIdZ" type="hidden" value="${sect.devZName}" />

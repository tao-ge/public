...
<head>
	...
	<script  type="text/javascript" src="${path }/js/iam/deviceCount.js"></script>
	...
	<div class="tools">
		<div class="simpleQuery" style="margin-right: 35%;">
	 	<form id="searchlistform" name="searchlistform">
	 		所属区 : 
	 		<select class="areadevCode" id="areadevCode" name="areadevCode" runat="server" selected="selected">
	     	...
	     	<select name="areaCode1" id="areaCode2" class="hjq" runat="server" selected="selected">

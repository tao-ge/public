...
<head>
	...
	<script  type="text/javascript" src="${path }/js/deviceStatus/deviceNewStatusList.js?aaa"></script>
...
<body>
	...
	<div class="place">
	    ...
	    <li><a href="devNewStatusList.htm">设备当前状态</a></li>
	    </ul>
    </div>
    ...
    <div class="rightinfo">
	    ...
	    <div class="tools">
	        ...
	        <div class="simpleQuery">
	           <form>
	                                       设施名称：<input name="devName_search" id="devNameSearch"  value="${devStaCon.fName}"   type="text" />
	                                      设施编码：<input name="devCode_search"  id="devCodeSearch"  value="${devStaCon.devCode}"  type="text" />
	                门状态：  <select name="doorStatus_search" id="doorStatusSearch" >
		  ...
		  锁状态：<select name="lockStatus_search" id="lockStatusSearch" >
				          <option value="">全部</option>
	                      <c:forEach  items="${doorAndLockStatusMap}" var="item" varStatus="status">
...
<%-- 		        <td>${f.doorStatusName}</td> --%>
	...
	<div id="div_moreSearch" class="newlayer" style="display:none;">
	       <form action="" method="post" id="moreSearchForm" name="moreSearchForm">
			     ...
			     <tr>
			       <td>设施名称：</td>
			       <td><input id="fName" name="fName" type="text"  value="${devStaCon.fName}" /></td>
			     </tr>			
			     <tr>
			       <td>开始时间：</td>

...
public class LatitudeLontitudeUtil {
	...
	public static LocationNearby getRectangle4Point(double lat, double lng,
			double distance) {
		LatitudeLontitudeUtil llu = new LatitudeLontitudeUtil(distance);
		llu.getRectangle4Point(lat, lng);
		
		LocationNearby locationNearby = new LocationNearby();
		locationNearby.setLeft_top(llu.left_top);
		locationNearby.setRight_top(llu.right_top);
		locationNearby.setLeft_bottom(llu.left_bottom);
		locationNearby.setRight_bottom(llu.right_bottom);
	...
	public static void main(String[] args) {
		...
		LocationNearby locationNearby = LatitudeLontitudeUtil.getRectangle4Point(lat,
				lng, distance);

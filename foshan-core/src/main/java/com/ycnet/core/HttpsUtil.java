...
//	public static String SELFCERTPATH = "www.ycthingnet.com.pkcs12";
//
//	public static String SELFCERTPWD = "cv68ajnmbg52bq";
    
	public static String SELFCERTPATH = "ycthingnet.p12";
	
	public static String SELFCERTPWD = "ycthingnet";

	public static String TRUSTCAPATH = "gc_server.keystore";
	...
	public static String TRUSTCAPWD = "231725";
	...
	public void initSSLConfigForTwoWay() throws Exception {
	    ...
	    String path = request.getSession().getServletContext().getRealPath("/")+"WEB-INF/classes/com/ycnet/web/config/";
		// 1闁靛棔绀侀閬嶅礂閵夈劌娈扮�规瓕绮鹃惁澶嬬▕閿燂拷
		KeyStore selfCert = KeyStore.getInstance("pkcs12");
		try {
			selfCert.load(new FileInputStream(path+SELFCERTPATH), SELFCERTPWD.toCharArray());
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			caCert.load(new FileInputStream(path+TRUSTCAPATH), TRUSTCAPWD.toCharArray());
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		sr.register(new Scheme("https", 8888, ssf));

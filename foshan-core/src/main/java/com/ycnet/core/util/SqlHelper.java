...
public class SqlHelper {
    ...
    private static final ReflectorFactory DEFAULT_REFLECTORY_FACTORY= new DefaultReflectorFactory();
    ...
    public static MetaObject forObject(Object object) {
    	return MetaObject.forObject(object, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY, DEFAULT_REFLECTORY_FACTORY);
    }
    ...
    public static String getMapperSql(SqlSession session, Class<?> mapperInterface, String methodName, Object... args) {
        ...
        if (args != null && args.length == 1) {
            ...
            if (_params instanceof Map) {
                params.putAll((Map<String,Object>) params);
            }
        }

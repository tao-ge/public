...
public class ExcelUtil {
    ...
    public static boolean export2File2(
            String outputExcelFileName) throws Exception {
        return FileUtil.write(outputExcelFileName, export2ByteArray2(),
                true, true);
    }
    ...
    public static byte[] export2ByteArray2()
            throws Exception {
        return export2Stream2().toByteArray();
    }
    ...
    public static ByteArrayOutputStream export2Stream2()
            throws Exception {
        init();
